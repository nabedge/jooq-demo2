...
insert into book (isbn,title,author_id,publish_date) values ('001-0000000001', 'A Study in Scarlett', 1, '1887-01-01');
insert into book (isbn,title,author_id,publish_date) values ('001-0000000002', 'The Sign of Fourr', 1, '1890-01-01');
insert into book (isbn,title,author_id,publish_date) values ('001-8888880001', '少年探偵団', 3, '1937-01-01');
insert into book (isbn,title,author_id,publish_date) values ('001-9999990001', 'Norwegian Woodd', 2, '1987-01-01');
